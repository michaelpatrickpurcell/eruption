...
\begin{tikzpicture}[remember picture, overlay]
	\node[opacity=0.25] () at (current page.center) {\includegraphics[width=\pagewidth, height=\pageheight]{Images/eruption_background3.jpg}};
\end{tikzpicture}
}
...
\end{center}
\vspace{-0.0ex}
\includegraphics[scale=0.125]{Images/Icons/player_count_icon_purple.png} {\setmainfont[Scale=1.25]{Londrina-Solid}\Huge \raisebox{6.55pt}{\textcolor{eruption_purple}{:\ 2-6}}} \hfill \includegraphics[scale=0.125]{Images/Icons/player_age_icon_purple.png} {\setmainfont[Scale=1.125]{Londrina-Solid}\Huge \raisebox{6.55pt}{\textcolor{eruption_purple}{:\ 12+}}}\hfill \includegraphics[scale=0.125]{Images/Icons/playtime_icon_purple.png} {\setmainfont[Scale=1.125]{Londrina-Solid}\Huge \raisebox{6.55pt}{\textcolor{eruption_purple}{:\ 10-15}}}
\vspace{-0.25ex}
\flushleft
...
%\quad \includegraphics[width=0.7\columnwidth]{Images/one_volcano.png}
